...
{
    using Otel_Rezervasyon.Classes;
    using System;
    ...
    public class OtelContext : DbContext
    {
        ...
        // 'Otel_Rezervasyon.OtelContext' database on your LocalDb instance. 
        // 
        ...
        public virtual DbSet<Ýl> Ýller { get; set; }
        public virtual DbSet<Ýlce> Ýlceler { get; set; }
        ...
        public virtual DbSet<OtelResimleri> Resimler { get; set; }
